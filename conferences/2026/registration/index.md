...
description: >
  Register for TDWG 2026 in Oslo.  Links, Terms and Conditions, discounts, and FAQ
background:
...
Cancellations received before 2026-09-07 will receive a 90% refund. After that date, refunds will be limted to 50% of the ticket price. If circumstances prevent your participation in-person, we encourage converting your participation to virtual. Conversion to virtual will be refunded 90% of the difference between ticket prices. Note that all content contributors (presenting authors) must be registered for at least virtual participation to remain in the program.

## Discounts

Member discount codes have been emailed to current (2026) individual and institutional TDWG members. Each discount code is unqiue and provides a $75 USD discount on full professional registration for individual members up to five affiliates from an institutional member. If you institution is a [TDWG member](/about/membership/#institutional-members-2026), please coordinate use of discount codes with your institution's primary contact.

TDWG subsidises paticipation for individuals who are 
 - student
 - post-doc or retired
 - from a country the UN/World Bank categorizes as having a "Low" or "Lower-middle" income economy.
