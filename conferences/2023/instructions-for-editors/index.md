...
![ARPHA Preliminary Assessment](https://static.tdwg.org/images/journal/arpha-preliminary-assessment.png "ARPHA Preliminary Assessment Flowchart")
...
- Use [flags](#understanding-flags) in ARPHA to mark editing progress
...
- Work with authors, reviewers, and editors (<editor@tdwg.org>) to reach the target to flag to approve the abstract (editors will make the final approval for publication).
...
Only volume editors of the Proceedings will send out approval notices that ask authors to finalize a checklist that will put the abstract in Pensoft’s publication workflow.
...
- If the deadline passes without anyone appearing to work on the draft, follow up with a personal email outside of ARPHA (they may not have seen the notification)
...
The abstract has not yet been submitted by the authors OR it has been returned to the authors for revision (via “Send Feedback”). Editors will have read-only access at this time.
...
Only submissions that are not relevant to the conference goals or collections will be rejected. If the abstract is not appropriate or does not fit in your collection, flag it and notify <editor@tdwg.org> of your opinion.
