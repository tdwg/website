...
Every contribution in the [2015 program](https://static.tdwg.org/conferences/2015/tdwg_2015_programme.pdf) has an ID number (#) and contains a link to its abstract in the Online Conference System. Some authors shared their presentations (PPT, PDF, etc.) and these are listed below (by author). To obtain any of these presentation files, please send a request to <secretariat@tdwg.org>.
